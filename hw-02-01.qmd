...
We will try to transform the len column with through several approaches and discuss the pros and cons of each. First however, we will remove `0` values, because len values are impossible...
...
still pretty funky but is the best of the transforms. But this variable was heavily skewed to the right to begin with.
